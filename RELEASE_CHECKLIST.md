...
- [ ] **SMTP custom configuré** (Resend, SendGrid ou autre) — le SMTP par défaut Supabase est limité à ~3 emails/h et ne supporte pas la prod. Domaine d'expédition vérifié (DKIM/SPF/DMARC actifs).
